...
import {Box, Button, List} from 'native-base';
import {HomeTabTitle} from '../../components/homeTabTitle';
import {NoActivityItem} from '../../components/noActivityItem';
  ...
  return (
    <TabScreenContainer>
      <TabScreenHeader>
        ...
        <HomeTabTitle screen="Activity" network="Polygon" />
